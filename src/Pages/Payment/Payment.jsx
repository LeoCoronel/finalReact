                            ...
                            <div className='form__row'>
                                <div className="fieldInput">
                                    ...
                                    <Field
                                        ...
                                        name='phone'
                                        id='phone'
                                        className={errors.phone && touched.phone ? 'input__error' : null}
                                    />
                                </div>
                            ...
                            <div className='form__row'>
                                <div className="fieldInput">
                                    ...
                                    <Field
                                        ...
                                        name='locality'
                                        id='locality'
                                        className={errors.locality && touched.locality ? 'input__error' : null}
                                    />
                                </div>
                                <ErrorMessage name='locality' component='span' className='error' />
                            </div>
                            <div className='form__row'>
                                <div className="fieldInput">
                                    ...
                                    <Field
                                        ...
                                        name='address'
                                        id='address'
                                        className={errors.address && touched.address ? 'input__error' : null}
                                    />
                                </div>
